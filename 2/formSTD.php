...
<head>
    ...
    <style>
        ...
        table {
            ...
            background-color: #fff; /* เปลี่ยนสีพื้นหลังของตารางเป็นสีส้ม */
            opacity: 0.9;
        }
        ...
        th {
            background-color: #ffa500; /* เปลี่ยนสีพื้นหลังของหัวตารางเป็นสีส้ม */
            color: white;
        }
        ...
        input[type="submit"],
        input[type="reset"] {
            background-color: #ffa500; /* เปลี่ยนสีปุ่มเป็นสีส้ม */
            color: white;
            padding: 10px 15px;
            border: none;
            border-radius: 4px;
        ...
        input[type="reset"]:hover {
            background-color: #ff8c00; /* เปลี่ยนสีเมื่อนำเมาส์มาอยู่บนปุ่ม */
        }
    </style>
</head>
<body>
    ...
    <form action="formSTDcal.php" method="get">
        <table width ="30%" border="1">
            <td colspan="2" style="background-color:#ffa500"><center><font size ="5">แบบฟอร์มนักศึกษา</font></center></td>
            <tr>
                <td>Name :</td>
